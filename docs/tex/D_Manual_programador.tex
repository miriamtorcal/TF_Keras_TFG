...
\imagen{evalMAP}{mAP del modelo de detección de las cabezas}
\imagen{infoEval}{información sobre la evalaución del modelo}
\imagen{prEval}{Precission-Recall de la clase \textit{head}}